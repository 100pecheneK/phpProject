    ...
    <div class="col-12 px-5 py-3">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    <input type="text" name="old_price" class="form-control" value="<?php if ($product->sale) echo "$product->old_price";
                                                                                        else echo 0 ?>" placeholder="Старая цена &#x20bd;">
                </div>
            </div>
            <!-- brand -->
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-3">
                    <img src="<?= Product::getMainImage($product->id) ?>" class="img-thumbnail">
            ...
            <div class="form-group row">
                ...
                <div class="col">
                    <img src="<?= Product::getBigImage($product->id) ?>" class="img-thumbnail">
