    ...
    <main role="main" class="container">
        <div class="row">
            ...
            <div class="col-md-8 blog-main">
                <div class="col">
                    <h3 class="font-italic">Все статьи</h3>
                </div>
                <div class="container">
                    <div class="row">
                    ...
                    if ($articles_exist) {
                        ...
                        <nav aria-label="Page navigation example">
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?> "><a class="page-link" href="articles.php?page=<?php echo 1; ?>">Первая</a></li>
                                <li class="page-item <?php if ($page <= 1) echo 'disabled'; ?> "><a class="page-link" href="articles.php?page=<?php echo ($page - 1); ?>">Назад</a></li>
                                <li class="page-item <?php if ($page >= $total_pages) echo 'disabled'; ?> "><a class="page-link" href="articles.php?page=<?php echo ($page + 1); ?>">Вперёд</a></li>
                                <li class="page-item <?php if ($page >= $total_pages) echo 'disabled'; ?> "><a class="page-link" href="articles.php?page=<?php echo $total_pages; ?>">Последняя</a></li>
                            </ul>
                            <ul class="pagination justify-content-center">
                                <li class="page-item <?php if ($page - 3 < 1) echo 'disabled'; ?>"><a class="page-link" href="articles.php?page=<?php echo ($page - 3); ?>">...</a></li>
                                <?php
                                for ($i = $page_left; $i <= $page_right; $i++) {
                                    ?>
                                    <li class="page-item <?php if ($i == $page) echo 'disabled'; ?>"><a class="page-link" href="articles.php?page=<?php echo $i; ?>"><?php echo $i ?></a></li>
                                <?php
                            }
                            ?>
                                <li class="page-item <?php if ($page + 3 > $total_pages) echo 'disabled'; ?>"><a class="page-link" href="articles.php?page=<?php echo ($page + 3); ?>">...</a></li>
                            </ul>
